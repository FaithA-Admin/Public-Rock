...
namespace Rock.Rest.Controllers
{
    ...
    public partial class PeopleController
    {
        ...
        public IQueryable<PersonSearchResult> Search( string name, bool includeHtml, bool includeDetails, bool includeBusinesses = false, bool includeDeceased = false, bool useLegalName = false )
        {
            ...
            {
                var simpleResultQry = sortedPersonQry.Select(a => new { a.Id, a.FirstName, a.NickName, a.MiddleName, a.LastName, a.SuffixValueId, a.RecordTypeValueId, a.RecordStatusValueId });
                var simpleResult = simpleResultQry.ToList().Select( a => new PersonSearchResult
                {
                    Id = a.Id,
                    Name = showFullNameReversed
                        ? useLegalName
                            ? Person.FormatFullNameReversed( a.FirstName, a.MiddleName, a.LastName, a.SuffixValueId, a.RecordTypeValueId )
                            : Person.FormatFullNameReversed( a.LastName, a.NickName, a.SuffixValueId, a.RecordTypeValueId )
                        : useLegalName
                            ? Person.FormatFullName( a.FirstName, a.MiddleName, a.LastName, a.SuffixValueId, a.RecordTypeValueId )
