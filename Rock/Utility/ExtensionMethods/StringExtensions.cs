...
namespace Rock
{
    ...
    public static partial class ExtensionMethods
    {
        ...
        /// <summary>
        /// Returns a sequence of characters found before the stopAt character.
        /// </summary>
        /// <param name="str">The string.</param>
        /// <param name="stopAt">The character used as a stop.</param>
        /// <returns></returns>
        public static string GetUntil( this string str, string stopAt )
        {
            int charLocation = str.IndexOf( stopAt, StringComparison.Ordinal );
