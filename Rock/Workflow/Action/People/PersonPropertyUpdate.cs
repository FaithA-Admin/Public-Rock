...
namespace Rock.Workflow.Action
{
    ...
    public class PersonPropertyUpdate : ActionComponent
    {
        ...
        public override bool Execute( RockContext rockContext, WorkflowAction action, Object entity, out List<string> errorMessages )
        {
                ...
                case "Title":
                    {
                        ...
                        {
                            History.EvaluateChange( changes, propertySelected, DefinedValueCache.GetName( person.TitleValueId ), DefinedValueCache.GetName( definedValueId ) );
                ...
                case "FirstName":
                    {
                        ...
                        {
                            History.EvaluateChange( changes, propertySelected, person.FirstName, updateValue );
                ...
                case "NickName":
                    {
                        if ( ignoreBlanks == false || !string.IsNullOrWhiteSpace( updateValue ) )
                        {
                            History.EvaluateChange( changes, propertySelected, person.NickName, updateValue );
                ...
                case "MiddleName":
                    {
                        if ( ignoreBlanks == false || !string.IsNullOrWhiteSpace( updateValue ) )
                        {
                            History.EvaluateChange( changes, propertySelected, person.MiddleName, updateValue );
                ...
                case "LastName":
                    {
                        if ( ignoreBlanks == false || !string.IsNullOrWhiteSpace( updateValue ) )
                        {
                            History.EvaluateChange( changes, propertySelected, person.LastName, updateValue );
                ...
                case "Suffix":
                    {
                        ...
                        if ( ignoreBlanks == false || definedValueId.HasValue )
                        {
                            History.EvaluateChange( changes, propertySelected, DefinedValueCache.GetName( person.SuffixValueId ), DefinedValueCache.GetName( definedValueId ) );
                ...
                case "Birthdate":
                    {
                        ...
                        if ( ignoreBlanks == false || birthdate.HasValue )
                        {
                            ...
                            {
                                History.EvaluateChange( changes, propertySelected, person.BirthDate, birthdate );
                            ...
                            {
                                History.EvaluateChange( changes, propertySelected, person.BirthDate, null );
                ...
                case "Gender":
                    {
                        ...
                        {
                            History.EvaluateChange( changes, propertySelected, person.Gender, gender.Value );
                ...
                case "MaritalStatus":
                    {
                        ...
                        if ( ignoreBlanks == false || definedValueId.HasValue )
                        {
                            History.EvaluateChange( changes, propertySelected, DefinedValueCache.GetName( person.MaritalStatusValueId ), DefinedValueCache.GetName( definedValueId ) );
                ...
                case "AnniversaryDate":
                    {
                        ...
                        {
                            History.EvaluateChange( changes, propertySelected, person.AnniversaryDate, anniversarydate );
                ...
                case "Email":
                    {
                        if ( ignoreBlanks == false || !string.IsNullOrWhiteSpace( updateValue ) )
                        {
                            History.EvaluateChange( changes, propertySelected, person.Email, updateValue );
                ...
                case "IsEmailActive":
                    {
                        ...
                        if ( ignoreBlanks == false || updateAsBoolean.HasValue )
                        {
                            ...
                            History.EvaluateChange( changes, propertySelected, person.IsEmailActive, updateAsBoolean.Value );
                ...
                case "EmailNote":
                    {
                        if ( ignoreBlanks == false || !string.IsNullOrWhiteSpace( updateValue ) )
                        {
                            History.EvaluateChange( changes, propertySelected, person.EmailNote, updateValue );
                ...
                case "EmailPreference":
                    {
                        ...
                        if ( ignoreBlanks == false || emailPreference.HasValue )
                        {
                            ...
                            History.EvaluateChange( changes, propertySelected, person.EmailPreference, emailPreference.Value );
                ...
                case "GraduationYear":
                    {
                        ...
                        {
                            History.EvaluateChange( changes, propertySelected, person.GraduationYear, updateAsInt );
                ...
                case "RecordStatus":
                    {
                        ...
                        if ( ignoreBlanks == false || definedValueId.HasValue )
                        {
                            History.EvaluateChange( changes, propertySelected, DefinedValueCache.GetName( person.RecordStatusValueId ), DefinedValueCache.GetName( definedValueId ) );
                ...
                case "RecordStatusReason":
                    {
                        ...
                        if ( ignoreBlanks == false || definedValueId.HasValue )
                        {
                            History.EvaluateChange( changes, propertySelected, DefinedValueCache.GetName( person.RecordStatusReasonValueId ), DefinedValueCache.GetName( definedValueId ) );
                ...
                case "InactiveReasonNote":
                    {
                        if ( ignoreBlanks == false || !string.IsNullOrWhiteSpace( updateValue ) )
                        {
                            History.EvaluateChange( changes, propertySelected, person.InactiveReasonNote, updateValue );
                ...
                case "ConnectionStatus":
                    {
                        ...
                        if ( ignoreBlanks == false || definedValueId.HasValue )
                        {
                            History.EvaluateChange( changes, propertySelected, DefinedValueCache.GetName( person.ConnectionStatusValueId ), DefinedValueCache.GetName( definedValueId ) );
                ...
                case "IsDeceased":
                    {
                        ...
                        if ( ignoreBlanks == false || updateAsBoolean.HasValue )
                        {
                            ...
                            History.EvaluateChange( changes, propertySelected, person.IsDeceased, updateAsBoolean.Value );
                ...
                case "SystemNote":
                    {
                        if ( ignoreBlanks == false || !string.IsNullOrWhiteSpace( updateValue ) )
                        {
                            History.EvaluateChange( changes, propertySelected, person.SystemNote, updateValue );
            ...
            if ( changes.Any() )
            {
                changes.Add( $"<em>(Updated by the '{action.ActionTypeCache.ActivityType.WorkflowType.Name}' workflow)</em>" );
