...
namespace Rock.Model
{
    ...
    public partial class RegistrationTemplate : Model<RegistrationTemplate>, IHasActiveFlag, ICategorized
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether the registration template is a contribution type.
        /// </summary>
        /// <value>
        ///     <c>true</c> if [is controbution enabled]; otherwise, <c>false</c>.
        /// </value>
        [DataMember]
        public RegistrationTemplateType RegistrationTemplateType { get; set; }
    ...
    public enum RegistrationTemplateType
    {
        ...
        /// </summary>
        ContributionRegistration = 1,

        /// <summary>
        /// Contribution Fundraising
        /// </summary>
        ContributionFundraising = 2
