...
", groupId ).FirstOrDefault();
        ...
        {
            AddNewGroupAddress( rockContext, group, locationTypeGuid, street1, street2, city, state, postalCode, country, moveExistingToPrevious, "" );
        }
            ...
            string modifiedBy )
        {
            ...
            AddNewGroupAddress( rockContext, group, locationTypeGuid, street1, street2, city, state, postalCode, country, moveExistingToPrevious, modifiedBy, isMappedMailing, isMappedMailing );
        }
