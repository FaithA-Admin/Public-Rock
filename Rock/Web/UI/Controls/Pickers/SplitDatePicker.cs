...
namespace Rock.Web.UI.Controls
{
    ...
    /// 
    /// </summary>
    public class SplitDatePicker : CompositeControl, IRockControl
    {
        ...
        [
            ...
            Category("Behavior"),
            DefaultValue(5),
            Description("The maximum year should be how many years from the current year?")
        ]
        public int MaxYearOffset
        {
            get { return ViewState["MaxYearOffset"] as int? ?? 5; }
            set { ViewState["MaxYearOffset"] = value; }
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SplitDatePicker"/> class.
        /// </summary>
        public SplitDatePicker()
            : base()
        {
        ...
        protected override void CreateChildControls()
        {
            ...
            monthDropDownList.RequiredErrorMessage = "Month is Required.";
            ...
            dayDropDownList.RequiredErrorMessage = "Day is Required.";
            ...
            yearDropDownList.RequiredErrorMessage = "Year is Required.";
        ...
        private void PopulateDropDowns()
        {
            ...
            for ( int year = RockDateTime.Now.AddYears(MaxYearOffset).Year; year >= 1900; year-- )
            {
