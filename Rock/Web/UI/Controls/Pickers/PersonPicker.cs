...
namespace Rock.Web.UI.Controls
{
    ...
    public class PersonPicker : CompositeControl, IRockControl
    {
        ...
        private HiddenFieldWithClass _hfUseLegalName;
        ...
        public bool UseLegalName
        {
            get
            {
                EnsureChildControls();
                return _hfUseLegalName.Value.AsBooleanOrNull() ?? false;
            }

            set
            {
                EnsureChildControls();
                _hfUseLegalName.Value = value.Bit().ToString();
            }
        }
        ...
        protected override void CreateChildControls()
        {
            ...
            _hfUseLegalName = new HiddenFieldWithClass();
            _hfUseLegalName.CssClass = "js-use-legal-name";
            Controls.Add( _hfUseLegalName );
            _hfUseLegalName.ID = "hfUseLegalName";
        ...
        public void RenderBaseControl( HtmlTextWriter writer )
        {
            if ( this.Enabled )
            {
                ...
                _hfUseLegalName.RenderControl( writer );
