...
namespace Rock.Workflow.Action
{
    ...
    [ExportMetadata( "ComponentName", "Create Protection Reference" )]
    ...
    [WorkflowAttribute( "Person Attribute", "The person attribute to set the value to the person created.", 
    ...
    public class CreateProtectionReference : ActionComponent
    {
        /// <summary>
