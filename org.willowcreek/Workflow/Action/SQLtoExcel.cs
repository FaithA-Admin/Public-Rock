...
namespace org.willowcreek.Workflow.Action
{
    ...
    [WorkflowAttribute( "File Name Attribute", "The name of the file that will be sent to the user.", true, "", "", 2 )]
    [WorkflowAttribute( "Redirect Location Attribute", "The URL where the file can be found", false, "", "", 3 )]
