...
namespace org.willowcreek
{
    public static class Extensions
    {
        ...
        /// <summary>
        /// Gets next occurance of 'day' including today
        /// Use DateTime.Today.AddDays(1) to not include today
        /// </summary>
        ...
        #region Willow Models

        public static String FullLegalName(this Person person)
        {
            var fullName = new StringBuilder();
            fullName.AppendFormat("{0} {1}{2}", person.FirstName, person.MiddleName + " ", person.LastName);
            return fullName.ToString();
        }

        /// <summary>
        /// Persons the alias guids.
        /// </summary>
        /// <param name="person">The person.</param>
        /// <returns>List&lt;Guid&gt;.</returns>
        public static List<Guid> PersonAliasGuids(this Person person)
        {
            return person.Aliases.Select(a => a.Guid).ToList();
        }
        /// <summary>
        /// Persons the alias ids.
        /// </summary>
        /// <param name="person">The person.</param>
        /// <returns>List&lt;System.Int32&gt;.</returns>
        public static List<int> PersonAliasIds(this Person person)
        {
            return person.Aliases.Select(a => a.Id).ToList();
        }
        /// <summary>
        /// Persons the alias alias person ids.
        /// </summary>
        /// <param name="person">The person.</param>
        /// <returns>List&lt;System.Int32&gt;.</returns>
        public static List<int> PersonAliasAliasPersonIds(this Person person)
        {
            return person.Aliases.Select(a => a.AliasPersonId).ToList();
        }
        /// <summary>
        /// Persons the alias alias person guids.
        /// </summary>
        /// <param name="person">The person.</param>
        /// <returns>List&lt;Guid&gt;.</returns>
        public static List<Guid> PersonAliasAliasPersonGuids(this Person person)
        {
            return person.Aliases.Select(a => a.AliasPersonGuid).ToList();
        }
        #endregion
        ...
        /// <summary>
        /// Selects Descendants by case insensitive.
        /// </summary>
        /// <param name="container">The container.</param>
        /// <param name="descendantName">Name of the descendant.</param>
        /// <returns>IEnumerable&lt;XElement&gt;.</returns>
        public static IEnumerable<XElement> DescendantsCaseInsensitive(this XContainer container, string descendantName)
        {
            return from o in container.Descendants()
                   where string.Compare(o.Name.LocalName, descendantName, true) == 0
                   select o;
        }
        /// <summary>
        /// Selects Descendants by case insensitive.
        ...
        /// <param name="descendantName">Name of the descendant.</param>
        /// <returns>IEnumerable&lt;XElement&gt;.</returns>
        public static IEnumerable<XElement> DescendantsCaseInsensitive(this XElement element, string descendantName)
        {
            return from o in element.Descendants()
                   where string.Compare(o.Name.LocalName, descendantName, true) == 0
                   select o;
        }
        /// <summary>
        ...
        /// <param name="descendantName">Name of the descendant.</param>
        /// <returns>IEnumerable&lt;XElement&gt;.</returns>
        public static IEnumerable<XElement> DescendantsCaseInsensitive(this IEnumerable<XElement> elements, string descendantName)
        {
            return from o in elements.Descendants()
                   where string.Compare(o.Name.LocalName, descendantName, true) == 0
                   select o;
        }
        #endregion
