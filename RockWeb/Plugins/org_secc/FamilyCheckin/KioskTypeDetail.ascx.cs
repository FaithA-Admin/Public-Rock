...
namespace RockWeb.Plugins.org_secc.FamilyCheckin
{
    ...
    public partial class KioskTypeDetail : RockBlock, IDetailBlock
    {
        ...
        private void BindGroupTypes( string selectedValues )
        {
            ...
            // This will get all the group types, whether or not they have groups in them, and will not ignore top-level group types
            var primaryGroups = new GroupTypeService( new RockContext() ).GetAllAssociatedDescendentsOrdered( templateGroupTypeId ).ToList();
