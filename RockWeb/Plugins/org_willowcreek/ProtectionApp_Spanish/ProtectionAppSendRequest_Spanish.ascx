<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ProtectionAppSendRequest_Spanish.ascx.cs" Inherits="Plugins_org_willowcreek_ProtectionApp_ProtectionAppSendRequest_es" %>
        ...
        <asp:Panel ID="pnlView" runat="server" CssClass="panel panel-block">
            ...
            <div class="panel-body">
                ...
                <asp:Panel ID="pnlForm" runat="server" Visible="true" CssClass="js-send-request">
                    ...
                    <Rock:RockCheckBoxList ID="cblDataStatus" runat="server" Label="Data Status" DataValueField="Value" DataTextField="Text"></Rock:RockCheckBoxList>
                    ...
                    <Rock:NumberBox ID="nbUpdatedLessThan" runat="server" CssClass="input-width-sm" Label="Exclude people with a profile updated in the last (years)" Text="3" ></Rock:NumberBox>
