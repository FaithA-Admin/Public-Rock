<%@ Control Language="C#" AutoEventWireup="true" CodeFile="OnlineGivingImport.ascx.cs" Inherits="RockWeb.Plugins.org_willowcreek.Finance.OnlineGivingImport" %>
    ...
    <ContentTemplate>
        ...
        <asp:Panel ID="pnlView" runat="server" CssClass="panel panel-block">
            ...
            <div class="panel-heading">
                <h1 class="panel-title"><i class="fa fa-download"></i> Online Giving Import</h1>
            </div>
