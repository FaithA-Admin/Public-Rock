...
namespace RockWeb.Plugins.org_willowcreek.Cms
{
    [DisplayName("Redirect All Roles")]
    [Category("org_willowcreek > Cms")]
    [Description("Redirects the page to the URL provided, regardless of Security Role membership.")]
    ...
    public partial class RedirectAllRoles : Rock.Web.UI.RockBlock
    {
        ...
        private void RedirectToUrl(string url)
        {
            ...
            if( resolvedUrl != Request.Url.PathAndQuery )
            {
