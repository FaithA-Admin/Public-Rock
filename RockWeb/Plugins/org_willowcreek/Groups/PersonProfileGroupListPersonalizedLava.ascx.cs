...
{
    [DisplayName( "Person Profile Group List Personalized Lava" )]
    [Category( "org_willowcreek > Groups" )]
    [Description( "Lists all group that the person of the profile is a member of using a Lava template." )]
    ...
    public partial class PersonProfileGroupListPersonalizedLava : PersonBlock
    {
        ...
        private void ListGroups()
        {
            ...
            qry = qry.Where( m => m.PersonId == Person.Id
