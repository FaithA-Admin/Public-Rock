<%@ Control Language="C#" AutoEventWireup="true" CodeFile="GroupMemberList.ascx.cs" Inherits="RockWeb.Plugins.org_willowcreek.Groups.GroupMemberList" %>
                        ...
                        <div class="grid grid-panel">
                            ...
                            <Rock:Grid ID="gGroupMembers" runat="server" DisplayType="Full" AllowSorting="true" OnRowSelected="gGroupMembers_Edit" CssClass="js-grid-group-members" >
                                <Columns>
                                    ...
                                    <Rock:RockBoundField DataField="BirthDate" HeaderText="Birth Date" SortExpression="Person.BirthDate" Visible="false" DataFormatString="{0:M/dd/yyyy}" NullDisplayText =""/>
                                    <Rock:RockTemplateField HeaderText="Badges" Visible="false">
                                         <ItemTemplate>
                                            <%# Eval("Badges") %>
                                        </ItemTemplate>
                                    ...
                                    <Rock:DateField DataField="DateAdded" HeaderText="Date Added" SortExpression="DateTimeAdded.Value" />
                                </Columns>
                            </Rock:Grid>
                        </div>
                    </div>
