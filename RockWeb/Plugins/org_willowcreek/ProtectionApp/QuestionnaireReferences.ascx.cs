...
public partial class Plugins_org_willowcreek_ProtectionApp_QuestionnaireReferences : Rock.Web.UI.RockBlock 
{
    #region Reference1
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (CurrentPerson == null)
        {
            ...
            if (!string.IsNullOrEmpty(impersonatedPersonKey))
            {
                ...
                var url = "/MyAccount/ProtectionAppReferences/" + applicant.UrlEncodedKey + "?WorkflowId=" + workflowId;
                Response.Redirect(url);
            }
        }

        var validationResult = ProtectionRouter.GetValidatedWorkflow(context, workflowService, CurrentPerson, workflowId, 54);
        ...
        {
            ProtectionRouter.GoToNextIncompleteStep(context, validationResult.Workflow, Response, false);
        }
