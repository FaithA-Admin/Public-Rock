...
//{
    /// <summary>
    /// Block to build a list of people who should receive a profile request.
    /// </summary>
    [DisplayName( "Send Protection App Request" )]
    [Category( "org_willowcreek > Protection App" )]
    [Description( "Block for selecting criteria to build a list of people who should receive a Profile request." )]
    [CommunicationTemplateField( "Protection App Request Template", "The template to use with this block to send requests.", true, "B9A0489C-A823-4C5C-A9F9-14A206EC3B88" )]
    ...
    public partial class Plugins_org_willowcreek_ProtectionApp_ProtectionAppSendRequest : Rock.Web.UI.RockBlock
    {
        #region Fields
        ...
        private void BindCheckBoxLists()
        {
            ...
            //TODO: add to org.willowcreek.protectonApp definedtype.cs PERSON_DATA_STATUS
            //cblDataStatus.BindToDefinedType(DefinedTypeCache.Read(Rock.SystemGuid.DefinedType.PERSON_DATA_STATUS.AsGuid()));
            cblDataStatus.BindToDefinedType(DefinedTypeCache.Read("0B4DDE85-152F-4DBE-988E-397C3EFFBC93".AsGuid()));
        }
