...
public partial class Plugins_org_willowcreek_ProtectionApp_ReferenceForm : Rock.Web.UI.RockBlock
{
    /// <summary>
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string spanishVersionURL = HttpContext.Current.Request.Url.AbsoluteUri.Replace( "ReferenceCheck", "ReferenceCheck_Spanish" );
        translateToSpanish.HRef = spanishVersionURL;
