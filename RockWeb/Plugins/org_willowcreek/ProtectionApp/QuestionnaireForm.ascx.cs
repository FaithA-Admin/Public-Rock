...
public partial class Plugins_org_willowcreek_ProtectionApp_QuestionnaireForm : Rock.Web.UI.RockBlock 
{
    #region Fields
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        var validationResult = ProtectionRouter.GetValidatedWorkflow(context, workflowService, CurrentPerson, workflowId, 53);
