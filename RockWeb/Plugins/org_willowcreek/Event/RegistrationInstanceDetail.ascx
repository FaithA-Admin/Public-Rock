<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RegistrationInstanceDetail.ascx.cs" Inherits="RockWeb.Plugins.org_willowcreek.Event.RegistrationInstanceDetail" %>
                ...
                <asp:Panel ID="pnlRegistrations" runat="server" Visible="false" CssClass="panel panel-block">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="grid grid-panel">
                            <div class="panel-heading clearfix grid-actions">
                                <div class="panel-labels">
                                    <asp:PlaceHolder ID="phRegistrationsGridActions" runat="server" />
                                </div>
                            </div>
                            ...
                            <Rock:Grid ID="gRegistrations" runat="server" DisplayType="Full" AllowSorting="true" OnRowSelected="gRegistrations_RowSelected" RowItemText="Registration"
                                ...
                                <Columns>
                                    ...
                                    <Rock:RockTemplateField HeaderText="Email">
                                        <ItemTemplate>
                                            <asp:Literal ID="lRegisteredByEmail" runat="server"></asp:Literal>
                                        </ItemTemplate>
                                    </Rock:RockTemplateField>
                                     <Rock:RockTemplateField HeaderText="Mobile">
                                        <ItemTemplate>
                                            <asp:Literal ID="lRegisteredByMobile" runat="server"></asp:Literal>
                                        </ItemTemplate>
                                    </Rock:RockTemplateField>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="grid grid-panel">
                            ...
                            <Rock:Grid ID="gRegistrants" runat="server" DisplayType="Full" AllowSorting="true" OnRowSelected="gRegistrants_RowSelected" RowItemText="Registrant" PersonIdField="PersonId" ExportSource="ColumnOutput">
                                <Columns>
                                    <Rock:SelectField ItemStyle-Width="48px" />
                                    <Rock:RockTemplateField HeaderText="First Name" SortExpression="PersonAlias.Person.FirstName" ExcelExportBehavior="NeverInclude">
                                        <ItemTemplate>
                                            <asp:Literal ID="lRegistrantFirstName" runat="server"></asp:Literal>
                                        </ItemTemplate>
                                    </Rock:RockTemplateField>
                                      <Rock:RockTemplateField HeaderText="Last Name" SortExpression="PersonAlias.Person.LastName" ExcelExportBehavior="NeverInclude">
                                        <ItemTemplate>
                                            <asp:Literal ID="lRegistrantLastName" runat="server"></asp:Literal>
                                        </ItemTemplate>
                                    </Rock:RockTemplateField>
                                    ...
                                    <Rock:RockTemplateField Visible="false" HeaderText="Country" ExcelExportBehavior="AlwaysInclude">
                                     ...
                                     <Rock:RockTemplateField Visible="false" HeaderText="Mobile Phone" ExcelExportBehavior="AlwaysInclude">
                                        <ItemTemplate>
                                            <asp:Literal ID="lMobilePhone" runat="server"></asp:Literal>
                                        </ItemTemplate>
                                    </Rock:RockTemplateField>
                                     <Rock:RockTemplateField Visible="false" HeaderText="Home Phone" ExcelExportBehavior="AlwaysInclude">
                                        <ItemTemplate>
                                            <asp:Literal ID="lHomePhone" runat="server"></asp:Literal>
                                        </ItemTemplate>
                                    </Rock:RockTemplateField>
                                     <Rock:RockTemplateField Visible="false" HeaderText="Work Phone" ExcelExportBehavior="AlwaysInclude">
                                        <ItemTemplate>
                                            <asp:Literal ID="lWorkPhone" runat="server"></asp:Literal>
                                        </ItemTemplate>
                                    </Rock:RockTemplateField>
