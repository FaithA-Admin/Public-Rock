<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ProfileUpdateBatchRequest.ascx.cs" Inherits="RockWeb.Plugins.org_willowcreek.ProfileUpdate.ProfileUpdateBatchRequest" %>
        ...
        <asp:Panel ID="pnlView" runat="server" CssClass="panel panel-block">
            ...
            <div class="panel-body">
                ...
                <asp:Panel ID="pnlForm" runat="server" Visible="true" CssClass="js-send-request">
                    ...
                    <Rock:NumberBox ID="nbAge" runat="server" CssClass="input-width-sm" Label="Age is more than" NumberType="Integer" Text="17" />
                    ...
                    <Rock:RockCheckBoxList ID="cblRecordStatus" runat="server" Label="Record Status" DataValueField="Value" DataTextField="Text"></Rock:RockCheckBoxList>
                    <Rock:NumberBox ID="nbCreatedLessThan" runat="server" CssClass="input-width-sm" Label="Exclude people created more than (months) ago" Text="12" ></Rock:NumberBox>
                    <Rock:NumberBox ID="nbProfileSentThan" runat="server" CssClass="input-width-sm" Label="Exclude people sent a profile email within (months)" Text="1" ></Rock:NumberBox>
                    <Rock:NumberBox ID="nbProfileCompletedThan" runat="server" CssClass="input-width-sm" Label="Exclude people with a completed profile in the last (months)" Text="12" ></Rock:NumberBox>
                    <Rock:RockCheckBox ID="clExcludeRestricted" runat="server" CssClass="input-width-sm" Label="Restricted" Checked="true" Text="Exclude Restricted" Enabled="false"></Rock:RockCheckBox>
