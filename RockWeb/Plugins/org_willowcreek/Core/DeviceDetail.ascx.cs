...
namespace RockWeb.Plugins.org_willowcreek.Core
{
    [DisplayName("Device Detail")]
    [Category("org_willowcreek > Core")]
    ...
    public partial class DeviceDetail : RockBlock, IDetailBlock
    {
        ...
        private void SetPrinterSettingsVisibility()
        {
            ...
            pnlPrinterSettings.Visible = ((ddlDeviceType.SelectedValue.AsIntegerOrNull() == checkinKioskDeviceTypeId) || (ddlDeviceType.SelectedValue.AsIntegerOrNull() == hybridCheckInDeviceTypeId));
