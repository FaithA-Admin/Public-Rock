<%@ Control Language="C#" AutoEventWireup="true" CodeFile="FamilySelect.ascx.cs" Inherits="RockWeb.Plugins.org_willowcreek.CheckIn.FamilySelect" %>
...
<ContentTemplate>
    ...
    <div class="checkin-header">
        <h1>
            <Rock:RockLiteral ID="lHeader" runat="server" Text="Families" />
        </h1>
    </div>
            ...
            <div class="scroller">
                ...
                <div class="control-group checkin-body-container">
                    <label class="control-label">
                        <Rock:RockLiteral ID="lSelectFamily" runat="server" Text="Select Your Family" />
                    </label>
                    <div class="controls">
