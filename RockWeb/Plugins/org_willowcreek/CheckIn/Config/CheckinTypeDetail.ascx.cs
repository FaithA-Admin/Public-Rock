...
namespace RockWeb.Plugins.org_willowcreek.CheckIn.Config
{
    [DisplayName( "Check-in Type Detail" )]
    [Category( "org_willowcreek > Check-in > Configuration" )]
    ...
    public partial class CheckinTypeDetail : RockBlock, IDetailBlock
    {
        ...
        protected void btnSave_Click( object sender, EventArgs e )
        {
            ...
            if ( groupType != null )
            {
                ...
                groupType.SetAttributeValue( "core_checkin_EnableKeypad", cbEnableKeypad.Checked.ToString() );
                groupType.SetAttributeValue( "core_checkin_EnableWebcam", cbEnableWebcam.Checked.ToString() );
                groupType.SetAttributeValue( "core_checkin_Theme", ddlTheme.SelectedValue );
                ...
                groupType.SetAttributeValue( "core_checkin_AppendFamilyNameInitialToSecurityCode", cbAppendFamilyNameInitialToSecurityCode.Checked.ToString() );
        ...
        private void ShowEditDetails( GroupType groupType )
        {
            if ( groupType != null )
            {
                ...
                cbEnableKeypad.Checked = groupType.GetAttributeValue( "core_checkin_EnableKeypad" ).AsBoolean( true );
                cbEnableWebcam.Checked = groupType.GetAttributeValue( "core_checkin_EnableWebcam" ).AsBoolean( true );
                ...
                if ( !string.IsNullOrWhiteSpace( groupType.GetAttributeValue( "core_checkin_Theme" ) ) )
                {
                    ddlTheme.SetValue( groupType.GetAttributeValue( "core_checkin_Theme" ) );
                }
                else
                {
                    ddlTheme.SetValue( "" );
                ...
                cbAppendFamilyNameInitialToSecurityCode.Checked = groupType.GetAttributeValue( "core_checkin_AppendFamilyNameInitialToSecurityCode" ).AsBoolean( true );
        ...
        private void BuildAttributeEdits( GroupType groupType, bool setValues )
        {
            ...
            excludeList.Add( "core_checkin_AppendFamilyNameInitialToSecurityCode" );
            excludeList.Add( "core_checkin_AutoSelectDaysBack" );
            excludeList.Add( "core_checkin_EnableKeypad" );
            excludeList.Add( "core_checkin_EnableWebcam" );
            excludeList.Add( "core_checkin_Theme" );
        ...
        private void SetFieldVisibility()
        {
            ...
            cbEnableKeypad.Visible = showPhoneFields;
            cbEnableWebcam.Visible = showPhoneFields;
        }
        ...
        private void ShowReadonlyDetails( GroupType groupType )
        {
            ...
            if ( groupType != null )
            {
                ...
                if( groupType.AttributeValues.ContainsKey( "core_checkin_AppendFamilyNameInitialToSecurityCode" ) )
                {
                    leftDetailsDescList.Add( "Append Family Name Initial To Security Code", groupType.AttributeValues["core_checkin_AppendFamilyNameInitialToSecurityCode"].ValueFormatted );
                }
