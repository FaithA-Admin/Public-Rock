<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CheckinTypeDetail.ascx.cs" Inherits="RockWeb.Plugins.org_willowcreek.CheckIn.Config.CheckinTypeDetail" %>
                        ...
                        <Rock:PanelWidget ID="wpGeneral" runat="server" Title="General Settings">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <Rock:RockCheckbox ID="cbAppendFamilyNameInitialToSecurityCode" runat="server" Label="Append Family Name Initial To Security Code" Text="Yes"
                                        Help="Should the first character of the family name be appended to the security code. (This character will count as part of the security code length)." />
                        ...
                        <Rock:PanelWidget ID="wpSearch" runat="server" Title="Search Settings">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <Rock:RockCheckBox ID="cbEnableKeypad" runat="server" Label="Enable Keypad" Text="Yes"
                                        Help="Enables the numeric search keypad." />
                                    <Rock:RockCheckBox ID="cbEnableWebcam" runat="server" Label="Enable Webcam" Text="Yes"
                                        Help="Enables the barcode reader webcam." />
                                </div>
                            </div>
                        </Rock:PanelWidget>
                        ...
                        <Rock:PanelWidget ID="wpAdvanced" runat="server" Title="Advanced Settings">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <Rock:RockDropDownList ID="ddlTheme" runat="server" CssClass="input-xlarge" Label="Kiosk Theme" 
                                        Help="Theme to use for kiosks that use this Check-In configuration." Required="true" />
                                </div>
                                <div class="col-md-6">
