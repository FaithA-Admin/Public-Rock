<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MultiPersonSelect.ascx.cs" Inherits="RockWeb.Plugins.org_willowcreek.CheckIn.MultiPersonSelect" %>
...
<ContentTemplate>
            ...
            <div class="scroller">
                ...
                <div class="control-group checkin-body-container">
                    <label class="control-label">
                        <Rock:RockLiteral ID="lSelectPeople" runat="server" Text="Select People" />
                    </label>
                    <div class="controls checkin-person-list" >
                        <asp:Repeater ID="rSelection" runat="server" >
                            <ItemTemplate>
                                <a person-id='<%# Eval("Person.Id") %>' Class="btn btn-primary btn-checkin-select btn-checkin-select-check btn-block js-person-select" style="text-align:left">
                                    <div class="row">
                                        <div class="col-md-2">
                ...
                <asp:Label ID="lAddPerson" runat="server" Visible="false" />
                <%--<a Class="btn btn-primary btn-checkin-select btn-block js-person-select" style="text-align:left" href="/checkin/addperson">
                    <div class="row">
                        <div class="col-md-2"><i class="fa fa-plus fa-3x"></i></div>
                        <div class="col-md-10 family-personselect">Add Person</div>
                    </div>
                </a>--%>
            </div>
        </div>
    ...
    <div class="checkin-footer">   
        <div class="checkin-actions">
            ...
            <a Class="btn btn-primary pull-right" style="margin-right:5px;" href="/checkin/addperson"><nobr><i class="fa fa-plus"></i> Add Person</nobr></a>
