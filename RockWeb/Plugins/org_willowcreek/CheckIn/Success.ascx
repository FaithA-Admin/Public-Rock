<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Success.ascx.cs" Inherits="RockWeb.Plugins.org_willowcreek.CheckIn.Success" %>
...
<ContentTemplate>
    ...
    <div class="checkin-header">
        <h1>
            <Rock:RockLiteral ID="lHeader" runat="server" Text="Checked-in" />
        </h1>
    </div>
