<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ParentLocation.ascx.cs" Inherits="RockWeb.Plugins.org_willowcreek.CheckIn.ParentLocation" %>
...
<ContentTemplate>
    ...
    <div class="checkin-header">
        <h1>
            <Rock:RockLiteral ID="lHeader" runat="server" Text="Parent Location" />
        </h1>
    </div>
