<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Bio.ascx.cs" Inherits="RockWeb.Plugins.org_willowcreek.Crm.PersonDetail.Bio" %>
               ...
               <h1 class="title name"><asp:Literal ID="lName" runat="server" /></h1>
                ...
                <div class="summary">
                    <div class="demographics">                        
                        ...
                        <asp:Literal ID="lSchools" runat="server"  /> 
                        <fieldset id="fsRockCheckinIds" runat="server" visible="false" />                    
                    </div>
                     ...
                     <div class="personcontact">
                        ...
                        <div class="email">
                         ...
                         <div>
                             <asp:Literal ID="lEmailPerson" runat="server" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Literal ID="lSMSPerson" runat="server" />
                         </div>
                    </div>
                </div>
