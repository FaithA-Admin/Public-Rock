                        ...
                        <div class="col-md-12">
                            <Rock:Grid ID="gServices" runat="server" AllowSorting="false" DisplayType="Light" RowItemText="Service Area" OnRowSelected="gServices_RowSelected" CssClass="wide">
                                <Columns>
                                    ...
                                    <Rock:DeleteField OnClick="gServices_Delete" ButtonCssClass="btn btn-sm btn-warning visit-cancel-button" IconCssClass="fa fa-minus" HeaderText="Cancel" Tooltip="Cancel"></Rock:DeleteField>
                                </Columns>
                            </Rock:Grid>
