            ...
            <Rock:ModalDialog ID="modalAddPerson" runat="server" Title="Add Relationship" ValidationGroup="NewRelationship">
                <Content>
                    ...
                    <div id="divExistingPerson" runat="server">
                        <fieldset>
                            <label class="control-label" for="grpRole">Relationship Type <Rock:HelpBlock ID="hbRelationshipType" runat="server" /></label>
                            <Rock:GroupRolePicker ID="grpRole" runat="server" ValidationGroup="NewRelationship" />

                            <p><Rock:PersonPicker ID="ppPerson" runat="server" Label="Person" Required="true" ValidationGroup="NewRelationship" IncludeBusinesses="true" />
