            ...
            <div class="panel-body container-fluid">
                ...
                <div id="pnlEditDetails" runat="server">
                    ...
                    <Rock:PanelWidget ID="pwDetails" runat="server" Title="Details" Expanded="true">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <Rock:RockDropDownList ID="ddlRegistrationTemplateType" runat="server" Label="Registration Template Type" 
                                    Help="For all regular events please chose the Event Registration option. For registrations that collect payments as that need to be marked as contributions choose either Contribution Registration or Contribution Fundraising accordingly."
                                    AutoPostBack="true" OnSelectedIndexChanged="ddlRegistrationTemplateType_SelectedIndexChanged" />
                            </div>                           
                        </div>
                        <hr />
                        <div class="row">
                    ...
                    <Rock:PanelWidget ID="wpTerms" runat="server" Title="Terms/Text">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <Rock:CodeEditor ID="ceSummaryText" runat="server" Label="Summary Text" EditorMode="Lava" EditorTheme="Rock" EditorHeight="300"
                                    Help="An optional text to display in the summary page where the registrar name is collected." />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                ...
                <fieldset id="fieldsetViewDetails" runat="server">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <Rock:RockLiteral ID="lRegistrationTemplateType" runat="server" Label="Template Type" />
