            ...
            <div class="panel panel-block">
                ...
                <div class="panel-body">
                    ...
                    <div id="pnlEditDetails" runat="server">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <Rock:PersonPicker ID="ppPerson" runat="server" Label="Registered By" OnSelectPerson="ppPerson_SelectPerson" EnableSelfSelection="true" IncludeBusinesses ="true" />
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <asp:Panel id="pnlPaymentInfo" runat="server" Visible="false" CssClass="well">
                                    ...
                                    <Rock:PersonPicker ID="ppPayee" runat="server" Label="Payee" Required="true" ValidationGroup="Payment" Help="The person who is making the payment." IncludeBusinesses="true" />
