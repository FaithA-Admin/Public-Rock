...
";
        ...
        protected void gAttendeesAttendance_RowDataBound( object sender, GridViewRowEventArgs e )
        {
            ...
            if ( personDates != null )
            {
                ...
                Literal lHomeAddressStreet = e.Row.FindControl( "lHomeAddressStreet" ) as Literal;
                Literal lHomeAddressCity = e.Row.FindControl( "lHomeAddressCity" ) as Literal;
                Literal lHomeAddressState = e.Row.FindControl( "lHomeAddressState" ) as Literal;
                Literal lHomeAddressPostalCode = e.Row.FindControl( "lHomeAddressPostalCode" ) as Literal;
                Literal lHomeAddressCountry = e.Row.FindControl( "lHomeAddressCountry" ) as Literal;
