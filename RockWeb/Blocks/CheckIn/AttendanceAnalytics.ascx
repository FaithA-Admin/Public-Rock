                            ...
                            <asp:Panel ID="pnlShowByAttendees" runat="server">
                                ...
                                <Rock:Grid ID="gAttendeesAttendance" runat="server" AllowSorting="true" RowItemText="Attendee" OnRowDataBound="gAttendeesAttendance_RowDataBound" ExportSource="ColumnOutput" ExportFilename="AttendanceAnalytics">
                                    <Columns>
                                        ...
                                        <Rock:RockLiteralField HeaderText="Home Address" ID="lHomeAddressStreet" ItemStyle-Wrap="false" />
                                        <Rock:RockLiteralField HeaderText="City" ID="lHomeAddressCity" ItemStyle-Wrap="false" />
                                        <Rock:RockLiteralField HeaderText="State" ID="lHomeAddressState" ItemStyle-Wrap="false" />
                                        <Rock:RockLiteralField HeaderText="Postal Code" ID="lHomeAddressPostalCode" ItemStyle-Wrap="false" />
                                        <Rock:RockLiteralField HeaderText="Country" ID="lHomeAddressCountry" ItemStyle-Wrap="false" />
