...
<asp:UpdatePanel ID="upContent" runat="server">
    ...
    <ContentTemplate>
        ...
        <div>
            <asp:Button ID="btnReloadKioskConfiguration" runat="server" OnClick="btnReloadKioskConfiguration_Click" Visible="false" />
        </div>
        <%-- Panel for no schedules --%>
        <asp:Panel ID="pnlNotActive" ClientIDMode="Static" runat="server">
        ...
        <asp:Panel ID="pnlNotActiveYet" ClientIDMode="Static" runat="server">
            <div class="checkin-header">
        ...
        <asp:Panel ID="pnlManager" runat="server" Visible="false">
            ...
            <div class="controls kioskmanager-actions checkin-actions">
                <asp:LinkButton ID="btnEnglishCheckinConfiguration" runat="server" CssClass="btn btn-default btn-large btn-block btn-checkin-select" Text="English Setup" OnClick="btnEnglishCheckinConfiguration_click" />
                <asp:LinkButton ID="btnSpanishCheckinConfiguration" runat="server" CssClass="btn btn-default btn-large btn-block btn-checkin-select" Text="Spanish Setup" OnClick="btnSpanishCheckinConfiguration_click" />
                ...
                <div class="checkin-scroll-panel">
                    <div class="scroller">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <p><b>HostName: </b><asp:Literal ID="lHostName" runat="server" /></p>
