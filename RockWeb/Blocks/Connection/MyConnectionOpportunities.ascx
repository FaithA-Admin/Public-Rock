                ...
                <div class="grid grid-panel">
                    ...
                    <Rock:Grid ID="gRequests" runat="server" OnRowSelected="gRequests_Edit" CssClass="js-grid-requests" AllowSorting="true" OnRowDataBound="gRequests_RowDataBound" >
                        <Columns>
                            ...
                            <Rock:RockBoundField DataField="Mobile" HeaderText="Mobile" />
                            ...
                            <Rock:RockBoundField DataField="LastActivityDate" HeaderText="Last Activity Date" HtmlEncode="false" SortExpression="LastActivityDate.CreatedDateTime" />
