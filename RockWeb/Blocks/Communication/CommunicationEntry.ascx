                         ...
                         <div class="panel-body">
                                ...
                                <div class="pull-right">
                                    ...
                                    <asp:LinkButton ID="lbRemoveAllRecipients" runat="server" Text="Remove All Pending Recipients" CssClass="remove-all-recipients btn btn-action btn-xs" OnClick="lbRemoveAllRecipients_Click" CausesValidation="false"/>
                                     <Rock:RockCheckBox ID="cbUniqueEmailPhone" runat="server" Text="Single message per address / phone" 
                                        Help="When checked, this Communication will only be sent once to each email address / phone number, even if multiple people have the same email address / phone number on their record." />
                                </div>
                        </div>
                    </div>
