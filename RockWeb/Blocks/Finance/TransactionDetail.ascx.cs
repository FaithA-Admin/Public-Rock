...
namespace RockWeb.Blocks.Finance
{
    ...
    [BooleanField("Show Legal Name", "Should the person picker show the full legal name (first, middle, last, suffix) rather than using the nickname?", order: 4 )]
...
";
            ...
            ppAuthorizedPerson.UseLegalName = GetAttributeValue( "ShowLegalName" ).AsBoolean();
        }
        ...
        public void ShowDetail( int transactionId, int? batchId )
        {
            ...
            if ( txn == null )
            {
                ...
                // If this is the first transaction entered for this batch, default the date to the batch start date
                if ( batch != null )
                {
                    txn.TransactionDateTime = batch.BatchStartDateTime;
                }
