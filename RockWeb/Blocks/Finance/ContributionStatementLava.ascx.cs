...
<p class=""text-center"">
    ...
    public partial class ContributionStatementLava : Rock.Web.UI.RockBlock
    {
        ...
        private void DisplayResults()
        {
            ...
            details = details.Where( d => !d.Transaction.FinancialPaymentDetail.Attributes.ContainsKey( conduitKey ) || d.Transaction.FinancialPaymentDetail.AttributeValues[conduitKey].Value == string.Empty ).ToList();
            ...
            mergeFields.Add( "TransactionDetails", details );

            mergeFields.Add("AccountSummary", details.GroupBy(t => new { t.Account.Name, t.Account.PublicName, t.Account.Description })
