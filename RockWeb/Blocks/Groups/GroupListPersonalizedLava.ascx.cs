...
namespace RockWeb.Blocks.Groups
{
    ...
    [BooleanField( "Restrict group toolbox link only to group leaders and administrators.", "Set this to true if only group leaders and administrators should see a link to the group toolbox block.", false, key: "RestrictGroupToolboxLinkToLeadersOnly", order: 7 )]
    public partial class GroupListPersonalizedLava : RockBlock
    {
        ...
        private void ListGroups()
        {
            ...
            bool restrictGroupToolboxLinkToLeadersOnly = this.GetAttributeValue( "RestrictGroupToolboxLinkToLeadersOnly" ).AsBooleanOrNull() ?? false;
            mergeFields.Add( "RestrictGroupToolboxLinkToLeadersOnly", restrictGroupToolboxLinkToLeadersOnly );
            mergeFields.Add( "UserCanAdministrate", UserCanAdministrate );
