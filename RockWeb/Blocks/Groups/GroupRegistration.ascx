        ...
        <asp:Panel ID="pnlView" runat="server">
            ...
            <div class="row">
                <asp:Panel id="pnlCol1" runat="server">
                    ...
                    <Rock:BirthdayPicker ID="bpBirthdate" runat="server" Label="Birthdate" Required="true" />
                    <asp:Panel ID="pnlCellPhone" runat="server" CssClass="row">
                        <div class="col-sm-7">
                            <Rock:PhoneNumberBox ID="pnCell" runat="server" Label="Cell Phone" Required="true" />
                        </div>
                        <div class="col-sm-5">
                ...
                <asp:Panel ID="pnlCol2" runat="server" CssClass="col-md-6">
                    ...
                    <Rock:BirthdayPicker ID="bpSpouseBirthdate" runat="server" Label="Birthdate" Required="true" />
                    <div class="row">
                        <div class="col-sm-7">
                            <Rock:PhoneNumberBox ID="pnSpouseCell" runat="server" Label="Spouse Cell Phone" Required="true" />
                        </div>
                        <div class="col-sm-5">
                            <Rock:RockCheckBox ID="cbSpouseSms"  runat="server" Label="&nbsp;" Text="Enable SMS" />
                        </div>
                    </div>
                    <Rock:EmailBox ID="tbSpouseEmail" runat="server" Label="Email" Required="true" />
                </asp:Panel>
