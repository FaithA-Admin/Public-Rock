...
namespace RockWeb.Blocks.Groups
{
    ...
    public partial class GroupMemberDetail : RockBlock, IDetailBlock
    {
        ...
        protected override void OnLoad( EventArgs e )
        {
            ...
            else
            {
                ...
                if ( groupMember != null )
                {
                    ...
                    Rock.Attribute.Helper.AddEditControls( groupMember, phAttributes, false, BlockValidationGroup, excludedAttributes );
                }
            }
        }
        ...
        public void ShowDetail( int groupMemberId, int? groupId )
        {
            ...
            //Exclude small group group-member attribute dates.
            List<string> excludedAttributes = new List<string>() { "PendingDate", "InactiveDate", "ActiveDate" };
            Rock.Attribute.Helper.AddEditControls( groupMember, phAttributes, true, string.Empty, excludedAttributes  ,true );
            if ( readOnly )
            {
