        ...
        <asp:Panel ID="pnlView" runat="server" CssClass="panel panel-block">
            ...
            <div class="panel-body">
                ...
                <asp:Panel ID="pnlSearch" runat="server">
                    ...
                    <Rock:AddressControl ID="acAddress" runat="server" Required="false" RequiredErrorMessage="Your Address is Required" Label="Please type in your address" />
                    ...
                    <div class="actions">
                        <Rock:RockTextBox ID="txtSearch" runat ="server" Label="Group name or description (optional)" Visible="false" />
                ...
                <asp:Panel ID="pnlResults" runat="server" Visible="false">
                    ...
                    <asp:Panel ID="pnlMap" runat="server" CssClass="margin-v-sm">
                        <div style="text-align:center;">
                            <Rock:RockLiteral runat="server" Label="Pin locations on map are not the actual physical locations of where the small group meets but does indicate a close proximity" />
                        </div>
                        <div id="map_wrapper">
                        ...
                        <div class="grid">
                            <Rock:Grid ID="gGroups" runat="server" RowItemText="Group" AllowSorting="true" OnRowSelected="gGroups_RowSelected">
                                <Columns>
                                    ...
                                    <Rock:RockBoundField DataField="Schedule" HtmlEncode="false" HeaderText="Schedule" />
                            ...
                            <Rock:PanelWidget ID="wpFilter" runat="server" Title="Filter Settings" Expanded="true">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <Rock:RockCheckBox ID="cbLoadAllGroupsByDefault" runat="server" Label="Load All Groups By Default" Text="Yes"
                                            Help="Load all groups by default when page loads" ValidationGroup="GroupFinderSettings" />
                                        ...
                                        <Rock:RockCheckBox ID ="cbSearchbox" runat="server" Label="Display Searchbox" Text="Yes" Help="Display Group Name or Description Searchbox" ValidationGroup="GroupFinderSettings" />
                            ...
                            <Rock:PanelWidget ID="wpMap" runat="server" Title="Map">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <Rock:RockCheckBox ID="cbAllowZoomOnMap" runat="server" Label="Allow Zoom On Map" Text="Yes"
                                            Help="Should the map allow zooming." ValidationGroup="GroupFinderSettings" />
                                        <Rock:RockCheckBox ID="cbHideRealGroupLocation" runat="server" Label="Hide Real Group Location" Text="Yes"
                                            Help="Should the map pins not reveal the real group location?" ValidationGroup="GroupFinderSettings" />
