(function ($) {
    ...
    Rock.controls.personPicker = (function () {
        ...
        PersonPicker.prototype.initializeEventHandlers = function () {
            ...
            var useLegalName = $('#' + controlId).find('.js-use-legal-name').val() == '1' ? 'true' : 'false';
            ...
            $('#' + controlId + '_personPicker').autocomplete({
                source: function (request, response) {
                    ...
                    promise = $.ajax({
                        url: restUrl + "?name=" + encodeURIComponent(request.term) + "&includeHtml=false&includeDetails=false&includeBusinesses=" + includeBusinesses + "&includeDeceased=true&useLegalName=" + useLegalName,
                        dataType: 'json'
                    });
