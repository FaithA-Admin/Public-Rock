<%@ WebHandler Language="C#" Class="RockWeb.Webhooks.WillowCreek.ProtectMyMinistry" %>
// <copyright>
...
namespace RockWeb.Webhooks.WillowCreek
{
    /// <summary>
        ...
        public void ProcessRequest( HttpContext context )
        {
            ...
            if ( request.Form["REQUEST"] != null )
            {
                try
                {
                    ...
                    {
                        ExceptionLogService.LogException(new Exception(xResult != null ? xResult.ToString() : "xResult is null"), context);
                    }
