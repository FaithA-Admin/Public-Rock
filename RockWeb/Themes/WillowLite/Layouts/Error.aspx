<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Error.aspx.cs" Inherits="RockWeb.Themes.WillowLite.Layouts.Error" %>
...
<head runat="server">
    ...
    <link rel="stylesheet" href="<%= Page.ResolveUrl("~/Themes/WillowLite/Styles/bootstrap.css") %>" />
    <link rel="stylesheet" href="<%= Page.ResolveUrl("~/Themes/WillowLite/Styles/theme.css") %>" />
