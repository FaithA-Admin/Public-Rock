...
{
    public class FileManagementContext : Rock.Data.DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            Database.SetInitializer<FileManagementContext>(new NullDatabaseInitializer<FileManagementContext>());
